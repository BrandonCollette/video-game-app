...
export default function Switch(props){
    ...
    return(
        <>
            ...
            <Navbar system="switch" title1="POPULAR TITLES" platform1='"fields name,rating,cover.image_id,platforms.name; limit 6; where rating > 80 & platforms = 130 & involved_companies.company = 70;"'
