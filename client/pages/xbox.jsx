...
export default function Playstation(props){
    ...
    return(
        <>
            ...
            <Navbar system="xbox" title1="POPULAR XBOX TITLES" platform1='"fields name,rating,cover.image_id,platforms.name; limit 6; where rating > 75 & platforms = 49 & genres = (5,10);"'
